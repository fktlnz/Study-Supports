...
const browserSyncOption = {
    proxy: "localhost:8888/Study-Support/",
...
gulp.task('watch', (done) => {
    ...
    //
    gulp.watch('src/scss/foundation/**/*.scss', gulp.task('sass'));
    gulp.watch('src/scss/layout/**/*.scss', gulp.task('sass'));
    gulp.watch('src/scss/object/**/*.scss', gulp.task('sass'));
    ...
    gulp.watch('dist/css/app.css', browserReload)
